...
import { Network, Trash2, Edit2, Key, Play, Loader2, Calendar, Eye, EyeOff } from 'lucide-react';
import {
    FormCard,
    ListCard,
    ActionButton,
                    ...
                    <div className="space-y-1">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full bg-transparent border border-border rounded-2xl p-4 pr-12 text-main placeholder:text-secondary/70 dark:placeholder:text-slate-700 outline-none focus:border-accent/50 transition-all font-mono shadow-inner"
