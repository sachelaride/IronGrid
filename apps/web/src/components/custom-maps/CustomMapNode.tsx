    ...
    return (
        ...
        >
            <div className={`relative flex flex-col items-center transition-all duration-200 ${isSelected ? 'scale-110' : ''}`}>
                ...
                <div className={`
                    p-2 rounded-2xl bg-slate-800 backdrop-blur-none border-2 transition-all shadow-xl
            ...
            <div className="mt-[-4px] flex flex-col items-center pointer-events-none">
                <div className="px-2.5 py-0.5 bg-black text-white text-[10px] font-black rounded-full border border-white/10 shadow-xl whitespace-nowrap uppercase tracking-wider">
