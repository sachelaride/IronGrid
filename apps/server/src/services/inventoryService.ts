        ...
        if (device) {
            ...
            device = await prisma.device.update({
                ...
                data: {
                    ...
                    rustdeskId: data.rustdeskId || device.rustdeskId,
                    rustdeskPassword: data.rustdeskPassword || device.rustdeskPassword
                }
            });
        } else {
            // Cria um novo dispositivo se realmente for inedito
